...
This repository contains a prototype implementation of a lambda function designed to run Liquibase updates on an Oracle database. The repository also contains a docker setup for a local copy of an Oracle 23c database for use in testing.
